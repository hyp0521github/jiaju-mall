                    ...
                    <div class="header-actions">
                        <div class="header_account_list">
                            ...
                            <div class="dropdown_search">
                                <form class="action-form" action="/customer/customerFurns">
                                    <input type="hidden" name="action" value="search">
                                    <input id="search_ipt" class="form-control" placeholder="请输入搜索家居名称"
                                           type="text" name="name">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                <img src="${furn.getImgPath()}" alt="Product"/>
                                                <img class="hover-image" src="${furn.getImgPath()}"
                                                     alt="Product"/>
                                            </a>
                                            <span class="badges">
                                        ...
                                        <div class="content">
                                            ...
                                            <span class="price">
                                                <span class="new">厂商:　${furn.getMaker()}</span>
                                            </span>
                                            <span class="price">
                                            ...
                                            <span class="price">
                                                <span class="new">库存:　${furn.getStock()}</span>
                                            </span>
                                        </div>
                                    </div>
                                    <!-- Single Prodect -->
...
<div class="pro-pagination-style text-center mb-md-30px mb-lm-30px mt-6" data-aos="fade-up">
    <ul>
        <li><a href="${requestScope.page.url}&pagesize=5&pageno=1">首页</a></li>
        ...
        <c:forEach var="pageno" begin="${begin}" end="${end}">
            <c:if test="${pageno == requestScope.page.pageno}">
                <li>
                    <a class="active"
                       href="${requestScope.page.url}&pagesize=5&pageno=${pageno}">${pageno}</a>
                </li>
            </c:if>
            <c:if test="${pageno != requestScope.page.pageno}">
                <li>
                    <a href="${requestScope.page.url}&pagesize=5&pageno=${pageno}">${pageno}</a>
                </li>
            </c:if>
        </c:forEach>
        <li><a id="next" data-pageno="${requestScope.page.pageno}"
               data-totalPages="${requestScope.page.totalPages}"
               href="${requestScope.page.url}&pageno=${requestScope.page.pageno + 1}">下页</a>
        </li>
        <li>
            <a href="${requestScope.page.url}&pagesize=5&pageno=${requestScope.page.totalPages}">末页</a>
        </li>
