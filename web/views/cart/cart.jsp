    ...
    <script type="text/javascript">
      $(function () {
        $(".cart-plus-minus").click(function () {
          ...
          let id = input.attr("furnId");
          let val = input.val();
          // 发起请求
          location.href = "http://localhost:8088/cart?action=update&id=" + id + "&count=" + val + "";
        })
                ...
                <form action="#">
                    <div class="table-content table-responsive cart-table-content">
                        <table>
                            ...
                            <tbody>
                            <c:forEach items="${sessionScope.cart.mp}" var="entry">
                                <tr>
                                    ...
                                    <td class="product-quantity">
                                        <div class="cart-plus-minus">
                                            <input class="cart-plus-minus-box" type="text" name="qtybutton"
                                                   furnId="${entry.value.id}" value="${entry.value.count}"/>
                                        </div>
                                    </td>
                                    <td class="product-subtotal">$${entry.value.totalPrice}</td>
                                    <td class="product-remove">
                                        <a id="delete" furnId="${entry.value.id}" href="/cart?action=delete&id=${entry.value.id}"><i class="icon-close"></i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        ...
                        <div class="col-lg-12">
                            <div class="cart-shiping-update-wrapper">
                                ...
                                <div class="cart-shiping-update">
                                    <a href="order?action=add">购 物 车 结 账</a>
                                </div>
                                <div class="cart-clear">
                                    <button>继 续 购 物</button>
                                    <a id="clear" href="/cart?action=clear">清 空 购 物 车</a>
                                </div>
                            </div>
                        </div>
                    </div>
