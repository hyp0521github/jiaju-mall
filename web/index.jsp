...
<div class="pro-pagination-style text-center mb-md-30px mb-lm-30px mt-6" data-aos="fade-up">
    <ul>
        <li><a href="#">首页</a></li>
        <li><a href="#">上页</a></li>
        <li><a class="active" href="/manage/manageFurns?action=page&pagesize=5&pageno=1">1</a></li>
        <li><a href="/manage/manageFurns?action=page&pagesize=3&pageno=2">2</a></li>
        <li><a href="/manage/manageFurns?action=page&pagesize=3&pageno=3">3</a></li>
        <li><a href="#">下页</a></li>
        <li><a href="#">末页</a></li>
        <li><a>共10页</a></li>
        <li><a>共90记录</a></li>
